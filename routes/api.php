...
Route::group([
    'middleware' => ['auth:api', 'admin'],//jwt token
    'namespace' => 'Api',
], function () {
    ...
    // order挂号
    Route::get('order', 'OrderController@index')->middleware(['permission:list_tag']);
    Route::post('order', 'OrderController@store')->middleware(['permission:create_tag']);
    Route::get('order/{id}/edit', 'OrderController@edit')->middleware(['permission:update_tag']);
    Route::patch('order/{id}', 'OrderController@update')->middleware(['permission:update_tag']);
    Route::delete('order/{id}', 'OrderController@destroy')->middleware(['permission:destroy_tag']);

    // drug
    Route::get('drug', 'DrugController@index')->middleware(['permission:list_tag']);
    Route::post('drug', 'DrugController@store')->middleware(['permission:create_tag']);
    Route::get('drug/{id}/edit', 'DrugController@edit')->middleware(['permission:update_tag']);
    Route::patch('drug/{id}', 'DrugController@update')->middleware(['permission:update_tag']);
    Route::delete('drug/{id}', 'DrugController@destroy')->middleware(['permission:destroy_tag']);
});
