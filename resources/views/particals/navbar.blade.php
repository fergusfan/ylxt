    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('doctors') }}">咨询医生</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/order') }}">预约挂号</a></li>
                {{--<li class="nav-item"><a class="nav-link" href="{{ url('/') }}">健康小知识</a></li>--}}
                <li class="nav-item"><a class="nav-link" href="{{ url('discussion') }}">健康论坛</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('drug') }}">小药箱</a></li>
            </ul>

            <!-- Right Side Of Navbar -->
            <ul class="navbar-nav navbar-right">
                <!-- Search Box -->
                <form class="form-inline my-2 my-lg-0 search" role="search" method="get" action="{{\Illuminate\Support\Facades\URL::full()}}/search">
