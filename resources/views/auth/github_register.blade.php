                        ...
                        <div class="form-group">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                       name="name" value="{{ $oauthData['github_name'] ?? '' }}" placeholder="{{ lang('Input Name') }}" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                       name="email" value="{{ $oauthData['email'] ?? '' }}" placeholder="{{ lang('Input Email') }}" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                       name="password" placeholder="{{ lang('Input Password') }}" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <input id="password-confirm" type="password" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}"
                                       name="password_confirmation" placeholder="{{ lang('Input Confirm Password') }}" required>
